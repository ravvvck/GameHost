...
namespace GameHost.Infrastructure.Migrations
{
    ...
    [Migration("20230306185500_addRefreshToken")]
            ...
            modelBuilder.Entity("GameHost.Domain.Sessions.Session", b =>
                {
                    ...
                    b.OwnsMany("GameHost.Domain.Session.Entities.Player", "Players", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("TEXT");
                            ...
                            b1.HasOne("GameHost.Domain.Sessions.Session", "Session")
                                .WithMany()
                                .HasForeignKey("SessionId1")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();

                            b1.HasOne("GameHost.Domain.Users.User", "User")
                                .WithMany()
                                .HasForeignKey("UserId")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();
